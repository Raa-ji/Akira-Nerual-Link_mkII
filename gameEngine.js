...
export default class GameEngine {
  ...
  initializeGame() {
    ...
    // Initialize viruses
this.viruses = [
  new Virus(1, 2 * TILE_SIZE, 2 * TILE_SIZE, 50),            // Top-left area
  new Virus(2, 60 * TILE_SIZE, 3 * TILE_SIZE, 50),           // Top-right area  
  new Virus(3, 62 * TILE_SIZE, 62 * TILE_SIZE, 50)          // Bottom-right area
];
